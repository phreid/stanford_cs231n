...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        captions_in_vectors, embed_cache = word_embedding_forward(captions_in, W_embed)

        if self.cell_type == 'rnn':
          h, rnn_cache = rnn_forward(captions_in_vectors, h0, Wx, Wh, b)
        elif self.cell_type == 'lstm':
          h, rnn_cache = lstm_forward(captions_in_vectors, h0, Wx, Wh, b)
        ...
        dout, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dout, temporal_affine_cache)
    ...
    def sample(self, features, max_length=30):
        ...
        while caption_index < 30:
            captions[:, caption_index] = current_word
